...
<html>
    <head>
        ...
        <title>Rocket Surgeons Guild - Abstractions</title>
    ...
    <body class="hold-transition wyam layout-boxed  ">    
        ...
        <div><p><a href="https://github.com/RocketSurgeonsGuild/rocketsurgeonsguild.github.io/blob/dev/input/docs/project/abstractions.md"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Content</a></p></div>
    <div id="infobar-headings"></div>
                ...
                <li class="treeview active">
                    ...
                    <ul class="treeview-menu">
                                        <li class="selected"><a href="/docs/project/abstractions.md">Abstractions</a></li>
