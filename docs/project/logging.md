...
<html>
    <head>
        ...
        <title>Rocket Surgeons Guild - Logging</title>
    ...
    <body class="hold-transition wyam layout-boxed  ">    
        ...
        <div><p><a href="https://github.com/RocketSurgeonsGuild/rocketsurgeonsguild.github.io/blob/dev/input/docs/project/logging.md"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Content</a></p></div>
    <div id="infobar-headings"></div>
                ...
                <li class="selected"><a href="/docs/project/logging.md">Logging</a></li>
