...
<html>
    ...
    <body class="hold-transition wyam layout-boxed  ">    
        ...
        <div><p><a href="https://rocketsurgeonsguild.github.io/blob/dev/input/docs/project/configuration.md"><i class="fa fa-pencil-square" aria-hidden="true"></i> Edit Content</a></p></div>
